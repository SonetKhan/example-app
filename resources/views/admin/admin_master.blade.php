                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user-menu">
                            <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                <img src="{{ \Illuminate\Support\Facades\Auth::user()->profile_photo_url }}" class="user-image" alt="User Image" />
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="dropdown-header">
                                    <img src="{{ \Illuminate\Support\Facades\Auth::user()->profile_photo_url }}" class="img-circle" alt="User Image" />
                                    <div class="d-inline-block">
                                        {{\Illuminate\Support\Facades\Auth::user()->name}} <small class="pt-1">{{\Illuminate\Support\Facades\Auth::user()->emali}}</small>
                                    </div>
                                </li>
